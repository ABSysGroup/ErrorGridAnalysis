function [total, percentage, eliminatedPoints, FinalPoints] = clarke(y,yp)
...
% SYNTAX:
% 
% [total, percentage, eliminatedPoints, FinalPoints] = clarke(y,yp)
% 
% INPUTS: 
...
%               [tot, per, deleted, points] = clarke(y,yp)
% 
% References:  
...
j=1;
for i=1:n
    if (y(i) < 400) & (y(i) < 400) & (yp(i) > 0) & (yp(i) > 0)
        y1(j)=y(i);
        yp1(j)=yp(i);
        j=j+1;
    else
